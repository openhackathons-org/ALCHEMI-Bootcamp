...
- [ ] Verify that the deployed BGR NIM is actually using the model, checkpoint, D3 setting, PBC, and optimizer described by the notebook.
  - Evidence should come from NIM metadata or container logs captured during execution.
