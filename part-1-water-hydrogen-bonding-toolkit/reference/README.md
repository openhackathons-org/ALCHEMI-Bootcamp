...
used in the tutorial exposes a learned residual and asks the wrapper to add
matched **two-body** D3(BJ) and Coulomb terms. Therefore:

- use this result as a full B97-3c endpoint reference;
- do not subtract Psi4's aggregate dispersion correction and label the
  remainder “the AIMNet residual”;
