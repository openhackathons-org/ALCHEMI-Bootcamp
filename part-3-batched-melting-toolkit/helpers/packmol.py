...
def _packmol_binary() -> str:
    """Return the Packmol executable installed in the tutorial environment."""

    executable = shutil.which("packmol")
    if executable is None:
        raise FileNotFoundError("Packmol is not available on PATH")
    return executable
...
def pack_liquid_box(
    ...
    packmol_binary = _packmol_binary()
