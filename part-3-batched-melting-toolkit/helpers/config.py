"""User-facing run configuration for the Part 3 melting-point tutorial.

One pydantic model bundles the few knobs a student touches with the parameters of
...
class Config(BaseModel):
    ...
    def _configure_runtime(self) -> None:
        ...
        # UserWarning even though NAPHTA10 supplies explicit symmetry operators.
