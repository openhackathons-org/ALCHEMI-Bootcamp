...
part_dir="${repo_root}/part-2-batched-adsorption-toolkit"
export PYTHONPATH="${part_dir}${PYTHONPATH:+:${PYTHONPATH}}"
...
runtime_cache="${part_dir}/outputs/runtime_cache"
...
exec "${python_bin}" \
  part-2-batched-adsorption-toolkit/scripts/run_toolkit_full_panel.py "$@"
